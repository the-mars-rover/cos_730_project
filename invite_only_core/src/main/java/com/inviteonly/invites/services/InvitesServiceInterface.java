...
@Service
public interface InvitesServiceInterface {

  /**
   * Create a new invite by a particular user for a space.
   *
   ...
   * @throws SpaceAuthorizationException if the user is not a manager for the space with the given
   *                                     ID.
   */
  Invite createInvite(String phoneNumber, Long spaceId)
