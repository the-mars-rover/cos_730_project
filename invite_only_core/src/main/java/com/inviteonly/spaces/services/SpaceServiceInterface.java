...
public interface SpaceServiceInterface {
   ...
   *
   * @param phoneNumber the phone number of the user creating/updating this space. This phone number
   *                    will be added as a to the manager phone numbers of the space if it is not
   *                    already.
   ...
   * @throws SpaceAuthorizationException if the space already exists and the given phone number is
   *                                     not one of the currently saved space's manager phone
   *                                     numbers.
   */
  Space updateSpace(String phoneNumber, Space space)
   ...
   * @throws SpaceAuthorizationException if the given phone number is not one of the currently saved
   *                                     space's manager phone numbers.
   */
  void deleteSpace(String phoneNumber, Long spaceId)
      throws SpaceNotFoundException, SpaceAuthorizationException;

  /**
   * Find the spaces for which a user is a manager, inviter or guard.
   *
   * @param phoneNumber the phone number of the user to get a list of spaces for.
   * @return a list of spaces for which the given phone number is part of the space's manager, guard
   *     or inviter phones.
   */
