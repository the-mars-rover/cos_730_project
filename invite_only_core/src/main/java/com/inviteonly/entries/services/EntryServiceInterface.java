...
public interface EntryServiceInterface {
  ...
  /**
   * Add an entry of to a particular space without an entry code.
   *
   ...
   * @throws DocNotFoundException        if the no document could be found matching the given
   *                                     document
  ...
  /**
   * Add an entry to a particular space with an entry code.
   *
   * @param phoneNumber the phone number of the user granting the entry
   * @param spaceId     the space id of the space that the entry is being granted for
  ...
  /**
   * Find the entries of a particular space that may be viewed the user.
   *
